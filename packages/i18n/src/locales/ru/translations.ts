export default {
  ...
  entity: {
    ...
    delete: {
      ...
      confirm_bulk: "Вы уверены, что хотите удалить {count} рабочих элементов? Это действие нельзя отменить.",
      bulk_success: "{count} рабочих элементов успешно удалено.",
      error: "Ошибка удаления {entity}.",
    },
    update: {
