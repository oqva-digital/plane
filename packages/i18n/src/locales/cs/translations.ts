export default {
  ...
  entity: {
    ...
    delete: {
      ...
      confirm_bulk: "Opravdu chcete smazat {count} pracovních položek? Tuto akci nelze vrátit zpět.",
      bulk_success: "{count} pracovních položek bylo úspěšně smazáno.",
      error: "Nepodařilo se smazat {entity}.",
    },
    update: {
