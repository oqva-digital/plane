export default {
  ...
  entity: {
    ...
    delete: {
      ...
      confirm_bulk: "Tem certeza que deseja excluir {count} item(ns) de trabalho? Esta ação não pode ser desfeita.",
      bulk_success: "{count} item(ns) de trabalho excluído(s) com sucesso.",
      error: "Falha ao excluir {entity}.",
    },
    update: {
