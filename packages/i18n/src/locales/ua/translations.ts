export default {
  ...
  entity: {
    ...
    delete: {
      ...
      confirm_bulk: "Ви впевнені, що хочете видалити {count} робочих елементів? Цю дію не можна скасувати.",
      bulk_success: "{count} робочих елементів успішно видалено.",
      error: "Не вдалося видалити {entity}.",
    },
    update: {
