export default {
  ...
  entity: {
    ...
    delete: {
      ...
      confirm_bulk: "Naozaj chcete zmazať {count} pracovných položiek? Túto akciu nie je možné vrátiť späť.",
      bulk_success: "{count} pracovných položiek bolo úspešne zmazaných.",
      error: "Nepodarilo sa zmazať {entity}.",
    },
    update: {
