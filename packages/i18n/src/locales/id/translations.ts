export default {
  ...
  entity: {
    ...
    delete: {
      ...
      confirm_bulk: "Apakah Anda yakin ingin menghapus {count} item kerja? Tindakan ini tidak dapat dibatalkan.",
      bulk_success: "{count} item kerja berhasil dihapus.",
      error: "Gagal menghapus {entity}.",
    },
    update: {
