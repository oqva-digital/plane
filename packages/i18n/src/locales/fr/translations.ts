export default {
  ...
  entity: {
    ...
    delete: {
      ...
      confirm_bulk: "Êtes-vous sûr de vouloir supprimer {count} élément(s) de travail ? Cette action est irréversible.",
      bulk_success: "{count} élément(s) de travail supprimé(s) avec succès.",
      error: "Échec de la suppression de {entity}.",
    },
    update: {
