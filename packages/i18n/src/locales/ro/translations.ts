export default {
  ...
  entity: {
    ...
    delete: {
      ...
      confirm_bulk: "Sigur doriți să ștergeți {count} element(e) de lucru? Această acțiune nu poate fi anulată.",
      bulk_success: "{count} element(e) de lucru șters(e) cu succes.",
      error: "Ștergerea {entity} a eșuat.",
    },
    update: {
