export default {
  ...
  entity: {
    ...
    delete: {
      ...
      confirm_bulk: "{count} iş öğesini silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.",
      bulk_success: "{count} iş öğesi başarıyla silindi.",
      error: "{entity} silinemedi.",
    },
    update: {
