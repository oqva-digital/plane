export default {
  ...
  entity: {
    ...
    delete: {
      ...
      confirm_bulk: "Czy na pewno chcesz usunąć {count} element(ów) pracy? Tej czynności nie można cofnąć.",
      bulk_success: "{count} element(ów) pracy pomyślnie usunięto.",
      error: "Nie udało się usunąć {entity}.",
    },
    update: {
